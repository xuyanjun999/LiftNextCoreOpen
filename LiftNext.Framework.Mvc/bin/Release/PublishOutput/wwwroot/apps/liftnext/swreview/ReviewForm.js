...
Ext.define('sef.app.liftnext.swreview.ReviewForm', {
    ...
    submitreview__execute: function (btn) {
        var form = this;
        var filters = [{ FieldName: 'ProjectID', Values: [form.recID], Rel: "And" }, { FieldName: 'ReviewStatus', Values: [100], Rel: "And" }, { FieldName: "IsCurrentVer", Values: [1], Rel: "And", Operator: 5 }];
    ...
    onRecordChange: function (rec) {
        var form = this;
        sef.utils.ajax({
            url: 'SwReview/LoadProjectParams',
            method: 'POST',
            paramAsJson: true,
            jsonData: {
                projectId: form.recID
