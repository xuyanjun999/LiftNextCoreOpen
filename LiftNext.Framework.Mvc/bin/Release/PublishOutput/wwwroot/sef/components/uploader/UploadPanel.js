...
Ext.define('sef.core.components.uploader.UploadPanel', {
    ...
    initComponent : function() {
        ...
        this.grid = Ext.create('sef.core.components.uploader.ItemGridPanel', {
            queue : this.queue,
        ...
        /*
        this.statusBar = Ext.create('sef.core.components.uploader.StatusBar', {
            dock : 'bottom',
    ...
    createUploadManager : function() {
        ...
        var uploadManager = Ext.create('sef.core.components.uploader.Manager', {
    ...
    getTopToolbarConfig : function() {
        ...
        this.browseButton = Ext.create('sef.core.components.uploader.BrowseButton', {
