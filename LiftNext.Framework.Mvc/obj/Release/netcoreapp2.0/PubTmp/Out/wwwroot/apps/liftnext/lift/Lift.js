...
Ext.define('sef.app.liftnext.lift.Lift', {
    ...
    requires: [
        ...
        'sef.app.liftnext.lift.LiftView'
    ...
    onTreeItemClick: function (tree, record) {
        tree.up('sef-liftlib').down('sef-liftview').store.makeQuerys({
            FieldName: 'Model.ModelClass', Values: [record.data.Data]
        });
    },
