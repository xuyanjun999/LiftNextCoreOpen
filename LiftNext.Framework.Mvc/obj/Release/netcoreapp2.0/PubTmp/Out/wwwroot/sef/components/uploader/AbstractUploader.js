 ...
 */
 ...
 //https://github.com/ivan-novakov/extjs-upload-widget/blob/master/lib/upload/uploader/AbstractUploader.js
...
Ext.define('sef.core.components.uploader.AbstractUploader', {
    ...
    initHeaders : function(item) {
        ...
        headers[this.filenameHeader] = encodeURIComponent(filename);
