...
{
    public class IndependentRepository : IIndependentRepository
    {

        private readonly IndependentDbContext _dbContext;

        private readonly ISQLBuilder _sqlBuilder;

        private readonly IWebHelper _webHelper;

        private readonly ILogger<IndependentRepository> _logger;

        public IndependentRepository(IndependentDbContext dbContext, ISQLBuilder sqlBuilder, IWebHelper webHelper, ILogger<IndependentRepository> logger)
        {
