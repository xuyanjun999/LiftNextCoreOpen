...
namespace LiftNext.Framework.Code.Util
{
    public static class HttpUtil
    {
        ...
        /// <returns></returns>
        public static string HttpPostRequest(string url, NameValueCollection data)
        {
            return HttpUploadFile(url, new string[] { }, data, DEFAULTENCODE);
        }
        ...
        public static string HttpUploadFile(string url, string file, NameValueCollection data, Encoding encoding)
        {
            ...
            {
                return HttpUploadFile(url, new string[] { }, data, encoding);
            }
        ...
        public static HttpWebResponse GetWebResponse(string url, string[] files, NameValueCollection data, Encoding encoding)
        {
        ...
        public static string HttpUploadFile(string url, string[] files, NameValueCollection data, Encoding encoding)
        {
            ...
            HttpWebResponse response = GetWebResponse(url, files, data, encoding);
            using (StreamReader stream = new StreamReader(response.GetResponseStream()))
            {
                return stream.ReadToEnd();
            }
        ...
        static Stream HttpUploadFileToStream(string url, string[] files, NameValueCollection data, Encoding encoding)
        {
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        public static Stream HttpUploadFileToStream(string url, string file, NameValueCollection data)
        {
            return HttpUploadFileToStream(url, new string[] { file }, data, DEFAULTENCODE);
        }
    }
}
