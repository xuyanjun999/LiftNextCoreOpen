...
namespace LiftNext.Framework.Code.Infrastructure
{
    ...
    {
        #region Fieldsd:\vs2017Project\EapFramework\Eap.Core\Infrastructure\AppDomainTypeFinder.cs

        private bool ignoreReflectionErrors = true;
        private bool loadAppDomainAssemblies = true;
        private string[] assemblySkipLoadingPattern = new string[] { "LiftNext.Framework.Mvc.PrecompiledViews" };
        ...
        protected virtual void LoadMatchingAssemblies(string directoryPath)
        {
            ...
            var aaa = Directory.GetFiles(directoryPath, "*.dll");
            foreach (string dllPath in Directory.GetFiles(directoryPath, "*.dll"))
            {
                try
                {
                    ...
                    if(AssemblySkipLoadingPattern.Any(x=> an.FullName.Contains(x)))
                    {
                        continue;
                    }
                    if (!loadedAssemblyNames.Contains(an.FullName) && an.FullName.Contains("LiftNext."))
                    {
                        App.Load(an);
                    }
